...
.content .desc {
  ...
  max-width: 680px;
      ...
      <header className="header">
        <span className="brand">Code Agent</span>
        <div className="actions">
          <Link className="signin" href="/code">
            Sign in
          </Link>
          <Link className="cta" href="/code">
            <GithubMark />
      ...
      <main className="hero">
        <div>
          <div className="kicker">Autonomous coding agent</div>
          <h1 className="title">
            Your AI engineer,
            <br />
            shipping PRs.
          ...
          <p className="subtitle">
            Describe the task. Code Agent plans, edits, and tests it inside its own isolated sandbox — then opens a
      ...
      <section className="content">
        ...
        <div className="heading">Connect a repo. Describe the task. Review the PR.</div>
        <p className="desc">
          Install the GitHub App on the repos you choose. Every task runs in its own disposable sandbox with a
          short-lived, repo-scoped token — nothing standing, nothing shared.
        </p>
      </section>
    </section>
  );
